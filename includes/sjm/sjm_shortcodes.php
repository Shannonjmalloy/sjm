...
class sjm_shortcodes {
    ...
    function __construct() {
        ...
        add_shortcode( 'related-work',    array( $this, 'related_work') );
    }
    ...
    function related_work( $atts ) {
        ...
        if ( sizeof($tags) < '3') {
            ...
            // just show the 3 most related posts
            $args = array(
                'post_type'      => 'work',
                'order'          => 'DSC',
                'tag__in'        => $tag_ids, 
                'post__not_in'   => array($post->ID), 
                'posts_per_page' => $related, // Number of related posts to display. 'caller_get_posts'=>1 
            );
        ...
        // if there are posts start the loop
        if ( $work->have_posts() ) :?>
            <div id="related-work" class="row loop-work-container" data-equalizer="">
